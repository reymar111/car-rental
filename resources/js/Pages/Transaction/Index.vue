                            ...
                            <tbody>
                                <tr class="bg-white border-b border-gray-200 hover:bg-gray-100"
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        ...
                                        <button  @click="OpenreleaseCarDialog(item)" v-if="item.status_id === 3" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none ">Release Car</button>
                                    </td>
                                </tr>
