...
export default {
    ...
    computed: {
        filteredRoutes() {
            ...
            return this.routes.filter(route => {
                return Object.values(route).some(value =>
    ...
    methods: {
        ...
        edit(route) {
            ...
            this.form.is_within = route.is_within
            this.form.name = route.name
            this.modal = true
        },

        update() {
            this.form.patch(`/route/update/${this.form.id}`, {
                onStart: () => {
                    this.loading_button = true;
                },
                onFinish: () => {
        ...
        destroy(id) {
            this.$inertia.delete(`/route/delete/${this.delete_form.id}`, {
                onStart: () => {
                    this.loading_button = true;
                },
                onFinish: () => {
        ...
        <div class="pb-4 bg-white dark:bg-gray-900">
            <div class="flex items-center gap-2">
                ...
                <div class="relative flex-1">
                    ...
                    <input v-model="search" type="text" id="table-search" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for province">
                </div>
            </div>
        </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                    v-for="(item, index) in filteredRoutes" :key="index">
                ...
                <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 border-b dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            {{ is_edit ? 'Update ' + form.name : 'Create'}} Province
                        </h3>
                    ...
                    <form class="p-4">
                        <div class="grid gap-2 mb-2">
                            ...
                            <input v-model="form.name" type="text" class="w-full p-2 border rounded-lg dark:bg-gray-600 dark:border-gray-500 dark:text-white" placeholder="Province name" required>
                            <InputError class="mt-2" :message="form.errors.name" />
                        </div>

                        <div class="flex  items-center gap-2 mb-5 mt-5">
                            <input v-model="form.is_within" id="default-checkbox" type="checkbox" :value="form.is_within" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">W/in Cagayan Valley</label>
                        </div>
